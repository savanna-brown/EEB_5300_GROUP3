...
| **Category**               | **Species**                                                                 |
|---------------------------|------------------------------------------------------------------------------|
| Eusocial Hymenoptera      | *Apis mellifera* (Western honeybee) <a href="[https://example.com](https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_003254395.2/)" target="_blank" rel="noopener noreferrer">NCBI link</a><br>*Harpegnathos saltator* (jumping ant) (https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_003227715.2/)<br>*Vespa crabro* (European hornet) (https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_910589235.1/)|
